...
//! no nulo visto), `row_count`, atributo `ai.split` si existe, y checksum
//! SHA-256 del JSON de records. El entrenamiento ocurre **fuera** de Jaiba.
    ...
    async fn execute(
        ...
        for record in records {
            ...
            for (key, value) in object {
                ...
                // Primer tipo observado por columna (no unifica tipos mixtos).
                dtypes
                    .entry(key.clone())
